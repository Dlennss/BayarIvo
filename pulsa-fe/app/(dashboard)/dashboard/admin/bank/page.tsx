  ...
  return (
    <div className="space-y-4 p-2">
      <div className="grid gap-3 md:grid-cols-[1.4fr_1fr]">
        <div className="rounded-2xl border border-emerald-900 bg-[#163d52] p-5 shadow-[0_16px_40px_-24px_rgba(6,78,59,0.35)]">
        ...
        <div className="grid gap-3">
          {isWalletMode ? (
            ...
            <>
              ...
              <div className="grid gap-1.5">
                <label className="text-sm font-medium">Nama Rekening</label>
                <Input value={atasNama} onChange={(e) => setAtasNama(e.target.value)} placeholder="Contoh: PT Bayarivo" />
              </div>
              <div className="grid gap-1.5">
                <label className="text-sm font-medium">Nomor Rekening</label>
