...
export default function NotFound() {
  return (
    <main className="min-h-[100svh] bg-[#f3f7fa] px-4 py-12 text-slate-950">
        ...
        <div className="w-full rounded-md border border-emerald-950/10 bg-white p-6 shadow-[0_24px_70px_rgba(6,78,59,0.14)]">
          ...
          <div className="mt-5 space-y-4">
            ...
            <p className="text-sm leading-6 text-slate-600">
              Link ini mungkin sudah berubah. Anda tetap dapat melihat dan membeli produk Bayarivo tanpa membuat akun.
            </p>
          </div>
