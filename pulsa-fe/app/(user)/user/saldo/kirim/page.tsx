    ...
    <main className="min-h-screen bg-[#f3f7fa] pb-24">
      <section className="relative overflow-hidden bg-[linear-gradient(135deg,#052e26_0%,#047857_62%,#84cc16_135%)] px-4 pb-7 pt-5 text-white shadow-[0_18px_42px_rgba(4,120,87,0.22)]">
        ...
        <div className="mx-auto flex w-full max-w-md items-center justify-between gap-3">
          ...
          <div className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-white text-[#126b9a] shadow-[0_12px_26px_rgba(6,78,59,0.18)]">
            <Zap className="h-5 w-5 fill-lime-300 text-[#126b9a]" strokeWidth={2.4} />
          </div>
        </div>
      </section>
      ...
      <div className="mx-auto -mt-3 w-full max-w-md space-y-4 px-4">
        <section className="rounded-[26px] border border-emerald-950/5 bg-white p-4 shadow-[0_18px_42px_rgba(6,78,59,0.10)]">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#126b9a]">Pilih Jenis</p>
              <h2 className="mt-1 text-xl font-black tracking-tight text-slate-950">Mau kirim ke mana?</h2>
            </div>
            <span className="grid h-10 w-10 place-items-center rounded-2xl bg-lime-100 text-[#126b9a]">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="rounded-full bg-emerald-50 px-2 py-1 text-[9px] font-black text-[#126b9a]">{item.badge}</span>
                  </div>
                  ...
                  <span className="absolute bottom-3 right-3 grid h-7 w-7 place-items-center rounded-full bg-slate-100 text-slate-500 transition group-hover:bg-lime-300 group-hover:text-[#163d52]">
