        ...
        <section className="flex min-h-0 flex-1 flex-col">
          ...
          <form className="mt-3 grid grid-cols-2 gap-3" method="GET">
            ...
            <div className="col-span-2 flex gap-2">
              <button
                type="submit"
                className="inline-flex h-10 flex-1 items-center justify-center rounded-md bg-[#126b9a] px-4 text-sm font-semibold text-white shadow-sm transition hover:bg-[#0a5dad]"
              >
                Terapkan
              </button>
              <Link
