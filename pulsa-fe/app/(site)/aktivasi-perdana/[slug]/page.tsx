...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Aktivasi Perdana | Bayarivo",
      description: "Pilih produk aktivasi perdana operator di Bayarivo.",
  ...
  return buildPageMetadata({
    title: `Aktivasi Perdana ${brandTitle} | Bayarivo`,
    description: lowestPrice
      ? `Pilih produk aktivasi perdana ${brandTitle} di Bayarivo. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih produk aktivasi perdana ${brandTitle} di Bayarivo dengan pilihan yang jelas.`,
...
export default async function AktivasiPerdanaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Aktivasi Perdana ${brandTitle} | Bayarivo`,
    description: `Pilih produk aktivasi perdana ${brandTitle} di Bayarivo dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah produk aktivasi perdana ${brandTitle} di Bayarivo tersedia lengkap?`,
      answer: `Ya. Bayarivo menampilkan produk aktivasi perdana ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli aktivasi perdana ${brandTitle} di Bayarivo?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dapat dipakai pembeli umum maupun member Bayarivo untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
