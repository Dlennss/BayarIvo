...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!phoneCategory) {
    return buildPageMetadata({
      title: "Paket Telepon Semua Operator | Bayarivo",
      description: "Pilih paket telepon operator di Bayarivo.",
      path: "/paket-telepon",
    });
  }
  ...
  return buildPageMetadata({
    title: `Paket Telepon ${brandTitle} | Bayarivo`,
    description: lowestPrice
      ? `Pilih paket telepon ${brandTitle} di Bayarivo. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih paket telepon ${brandTitle} di Bayarivo dengan pilihan produk yang jelas.`,
...
export default async function GuestPaketTeleponBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Paket Telepon ${brandTitle} | Bayarivo`,
    description: `Pilih paket telepon ${brandTitle} di Bayarivo dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah paket telepon ${brandTitle} di Bayarivo tersedia dalam banyak pilihan?`,
      answer: `Ya. Bayarivo menampilkan paket telepon ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli paket telepon ${brandTitle} di Bayarivo?`,
