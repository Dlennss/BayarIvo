...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!pulsaCategory) {
    return buildPageMetadata({
      title: "Pulsa Operator | Bayarivo",
      description: "Isi pulsa operator favorit Anda di Bayarivo.",
      path: "/pulsa",
    });
  }
  ...
  return buildPageMetadata({
    title: `Isi Pulsa ${brandTitle} Online | Bayarivo`,
    description: lowestPrice
      ? `Isi pulsa ${brandTitle} online di Bayarivo dengan nominal lengkap. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")} dan transaksi cepat.`
      : `Isi pulsa ${brandTitle} online di Bayarivo dengan nominal lengkap dan transaksi cepat.`,
    path: `/pulsa/${slug}`,
...
export default async function GuestPulsaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Isi Pulsa ${brandTitle} Online | Bayarivo`,
    description: `Isi pulsa ${brandTitle} online di Bayarivo dengan nominal lengkap dan transaksi cepat.`,
    path: `/pulsa/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah nominal pulsa ${brandTitle} di Bayarivo lengkap?`,
      answer: `Ya. Bayarivo menampilkan pilihan nominal pulsa ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara beli pulsa ${brandTitle} di Bayarivo?`,
      answer: `Pilih nominal pulsa ${brandTitle}, masukkan nomor tujuan, lalu lanjutkan pembayaran sesuai metode yang tersedia.`,
    },
    {
      question: `Apakah pembelian pulsa ${brandTitle} di Bayarivo bisa untuk calon member dan member?`,
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum, dan member Bayarivo juga bisa memanfaatkan pilihan produk yang sama untuk transaksi harian.`,
    },
  ]);
