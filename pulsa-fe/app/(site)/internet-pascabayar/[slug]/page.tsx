...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Internet Pascabayar | Bayarivo",
      description: "Cek dan bayar tagihan internet pascabayar di Bayarivo.",
      path: "/internet-pascabayar",
    });
  }

  return buildPageMetadata({
    title: `${toTitleCase(brand.nama)} | Internet Pascabayar Bayarivo`,
    description: `Cek dan bayar tagihan ${toTitleCase(brand.nama)} di Bayarivo dengan proses yang ringkas.`,
...
export default async function InternetPascabayarSlugPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brandTitle} | Internet Pascabayar Bayarivo`,
    description: `Cek dan bayar tagihan ${brandTitle} di Bayarivo dengan proses yang ringkas.`,
    path: `/internet-pascabayar/${slug}`,
