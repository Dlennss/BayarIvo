...
export const metadata: Metadata = buildPageMetadata({
  title: "Produk Listrik PLN | Bayarivo",
  description: "Pilih token listrik atau pembayaran tagihan listrik PLN di Bayarivo.",
  path: "/listrik",
  ...
  const cards = [
    {
      ...
      href: "/listrik/token",
      icon: Zap,
      accent: "from-lime-300 via-emerald-500 to-[#163d52]",
    },
    {
      key: "tagihan",
      ...
      icon: FileText,
      accent: "from-yellow-300 via-green-500 to-[#163d52]",
    },
  ];
    ...
    <main className="min-h-screen bg-[#f3f7fa]">
      ...
      <div className="space-y-4 px-4 pt-4 pb-28">
        {!listrikCategory ? (
          ...
          <>
            <section className="relative overflow-hidden rounded-[30px] bg-[#163d52] p-4 text-white shadow-[0_22px_48px_rgba(5,46,38,0.26)]">
              ...
              <div className="relative flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-[10px] font-black uppercase tracking-[0.18em] text-lime-200">Bayarivo PLN</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex items-center gap-3">
                    ...
                    <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-lime-100 text-[#163d52] transition group-hover:translate-x-0.5 group-hover:bg-lime-300">
