...
const pageTitle = "Syarat & Ketentuan Bayarivo | Layanan Produk Digital";
const pageDescription =
  "Syarat dan ketentuan penggunaan Bayarivo untuk transaksi produk digital, saldo, agent, marketing, dan kredit agent.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Syarat dan Ketentuan Bayarivo",
      },
    ],
  },
  twitter: {
