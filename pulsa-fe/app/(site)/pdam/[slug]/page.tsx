...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PDAM | Bayarivo",
      description: "Cek dan bayar tagihan PDAM di Bayarivo.",
      path: "/pdam",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PDAM Bayarivo`,
    description: `Cek dan bayar tagihan ${brand.nama} di Bayarivo dengan proses cepat dan ringkas.`,
    path: `/pdam/${slug}`,
