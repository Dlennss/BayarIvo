...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (universalService) {
    return buildPageMetadata({
      title: `${universalService === "esim-roaming" ? "eSIM & Roaming" : "HP Pascabayar"} | Bayarivo`,
      description: "Layanan digital Bayarivo.",
      path: `/kategori/${id}`,
    });
  }
  ...
  if (!category) {
    return buildPageMetadata({
      title: "Kategori Produk | Bayarivo",
      description: "Lihat kategori produk Bayarivo.",
      path: "/kategori",
    });
  }

  return buildPageMetadata({
    title: `${category.nama} | Bayarivo`,
    description: `Lihat pilihan brand dan produk ${category.nama} di Bayarivo.`,
    path: `/kategori/${id}`,
...
export default async function GuestKategoriPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${categoryName} | Bayarivo`,
    description: `Lihat pilihan brand dan produk ${categoryName} di Bayarivo.`,
    path: `/kategori/${id}`,
