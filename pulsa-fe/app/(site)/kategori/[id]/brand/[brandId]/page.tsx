...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: `${brand} | ${categoryName} Bayarivo`,
    description: `Lihat produk ${brand} pada kategori ${categoryName} di Bayarivo.`,
...
export default async function GuestBrandProductsPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brand} | ${categoryName || "Produk"} Bayarivo`,
    description: `Lihat produk ${brand} pada kategori ${categoryName || "produk"} di Bayarivo.`,
    path: `/kategori/${id}/brand/${brandId}`,
