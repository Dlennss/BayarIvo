...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Top Up E-Wallet | Bayarivo",
      description: "Top up e-wallet favorit Anda di Bayarivo.",
      path: "/ewallet",
    });
  }
  ...
  return buildPageMetadata({
    title: `Top Up ${brandTitle} Online | Bayarivo`,
    description: lowestPrice
      ? `Top up ${brandTitle} online di Bayarivo dengan nominal tetap dan bebas nominal. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Top up ${brandTitle} di Bayarivo dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
...
export default async function EwalletBrandPage({ params, searchParams }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Top Up ${brandTitle} Online | Bayarivo`,
    description: `Top up ${brandTitle} di Bayarivo dengan pilihan nominal tetap dan bebas nominal yang lebih jelas.`,
    path: `/ewallet/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah top up ${brandTitle} di Bayarivo bisa pilih nominal tetap dan bebas nominal?`,
      answer: `Ya. Bayarivo menampilkan produk ${brandTitle} yang aktif, termasuk nominal tetap dan varian bebas nominal bila tersedia.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dipakai untuk kebutuhan top up pribadi maupun penjualan ulang oleh member Bayarivo.`,
    },
  ]);
