...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PGN | Bayarivo",
      description: "Cek dan bayar tagihan gas PGN di Bayarivo.",
      path: "/pgn",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PGN Bayarivo`,
    description: `Cek dan bayar tagihan ${brand.nama} di Bayarivo dengan proses yang ringkas.`,
    path: `/pgn/${slug}`,
