...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Masa Aktif Semua Operator | Bayarivo",
      description: "Perpanjang masa aktif nomor Anda di Bayarivo.",
      path: "/masa-aktif",
    });
  }
  ...
  return buildPageMetadata({
    title: `Perpanjang Masa Aktif ${brandTitle} | Bayarivo`,
    description: lowestPrice
      ? `Perpanjang masa aktif ${brandTitle} di Bayarivo. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Perpanjang masa aktif ${brandTitle} di Bayarivo dengan pilihan produk yang jelas.`,
...
export default async function MasaAktifBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Perpanjang Masa Aktif ${brandTitle} | Bayarivo`,
    description: `Perpanjang masa aktif ${brandTitle} di Bayarivo dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah masa aktif ${brandTitle} di Bayarivo tersedia dalam beberapa pilihan?`,
      answer: `Ya. Bayarivo menampilkan produk masa aktif ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara memperpanjang masa aktif ${brandTitle} di Bayarivo?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member Bayarivo untuk kebutuhan pribadi dan penjualan ulang.`,
    },
  ]);
