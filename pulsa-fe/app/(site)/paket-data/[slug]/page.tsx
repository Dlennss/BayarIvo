...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!dataCategory) {
    return buildPageMetadata({
      title: "Paket Data Operator | Bayarivo",
      description: "Beli paket data operator favorit Anda di Bayarivo.",
      path: "/paket-data",
    });
  }
  ...
  return buildPageMetadata({
    title: `Paket Data ${brandTitle} Murah | Bayarivo`,
    description: lowestPrice
      ? `Beli paket data ${brandTitle} di Bayarivo dengan pilihan kuota aktif. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")} dan transaksi cepat.`
      : `Beli paket data ${brandTitle} di Bayarivo dengan pilihan kuota dan masa aktif yang jelas.`,
...
export default async function GuestPaketDataBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Paket Data ${brandTitle} Murah | Bayarivo`,
    description: `Beli paket data ${brandTitle} di Bayarivo dengan pilihan kuota dan masa aktif yang jelas.`,
    path: `/paket-data/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah paket data ${brandTitle} di Bayarivo tersedia dalam banyak pilihan kuota?`,
      answer: `Ya. Bayarivo menampilkan paket data ${brandTitle} yang aktif dengan pilihan kuota, masa aktif, dan grup produk yang lebih jelas.`,
    },
    {
      question: `Bagaimana cara beli paket data ${brandTitle} di Bayarivo?`,
    ...
    },
    {
      ...
      answer: `Halaman ini bisa dipakai pembeli umum maupun member Bayarivo untuk kebutuhan transaksi harian dan penjualan ulang.`,
    },
  ]);
