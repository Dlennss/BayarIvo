...
export const metadata: Metadata = buildPageMetadata({
  title: "Paket Data Semua Operator | Bayarivo",
  description: "Beli paket data harian, mingguan, dan bulanan semua operator di Bayarivo dengan pilihan grup produk yang lebih jelas.",
  path: "/paket-data",
