...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "TV Berlangganan | Bayarivo",
      description: "Beli paket atau bayar layanan TV berlangganan di Bayarivo.",
      path: "/tv",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | TV Berlangganan Bayarivo`,
    description: `Beli paket atau bayar layanan ${brand.nama} di Bayarivo dengan proses yang ringkas.`,
    path: `/tv/${slug}`,
