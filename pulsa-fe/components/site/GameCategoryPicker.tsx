...
function getTheme(name: string) {
  ...
  if (value.includes("mobile")) return "from-[#251405] via-[#163d52] to-[#16a34a]";
  if (value.includes("free fire")) return "from-[#09090b] via-[#163d52] to-[#f59e0b]";
  if (value.includes("magic")) return "from-[#243c5a] via-[#126b9a] to-[#f4ce73]";
  if (value.includes("call of duty")) return "from-[#020617] via-[#163d52] to-[#334155]";
  if (value.includes("genshin")) return "from-[#1b1030] via-[#163d52] to-[#16a34a]";
  if (value.includes("pubg")) return "from-[#111827] via-[#163d52] to-[#facc15]";
  if (value.includes("roblox")) return "from-[#020617] via-[#163d52] to-[#10b981]";
  if (value.includes("point")) return "from-[#020617] via-[#163d52] to-[#0f766e]";
  return "from-[#163d52] via-[#126b9a] to-[#22c55e]";
}
    ...
    <div className="space-y-3 pb-28">
      <section className="overflow-hidden rounded-[28px] border border-emerald-950/5 bg-linear-to-br from-white via-emerald-50/75 to-lime-50/70 p-3 shadow-[0_18px_42px_rgba(6,78,59,0.12)]">
        <div className="flex items-center justify-between gap-3 px-1 pb-3 pt-1">
          ...
          <span className="grid h-9 w-9 shrink-0 place-items-center rounded-2xl bg-[#163d52] text-lime-200 shadow-[0_10px_22px_rgba(5,46,38,0.18)]">
                ...
                >
                  ...
                  <div className="relative grid h-[104px] place-items-center overflow-hidden rounded-[20px] bg-black/18 ring-1 ring-white/12">
                    {item.logo?.src ? (
                      ...
                      <div className="grid h-full w-full place-items-center bg-linear-to-br from-[#163d52] to-[#10b981] text-white">
                  ...
                  <div className="relative mt-3 flex min-h-[38px] items-end justify-between gap-2">
                    ...
                    <span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-lime-300 text-[#163d52] shadow-[0_8px_16px_rgba(5,46,38,0.18)] transition duration-300 group-hover:translate-x-0.5">
