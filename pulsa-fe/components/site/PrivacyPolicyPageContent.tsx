...
const principles = [
  {
    ...
    items: [
      "Bayarivo menyediakan pulsa, paket data, token listrik, e-wallet, voucher game, PPOB, dan produk digital lain yang tersedia di aplikasi.",
  ...
  },
  {
    ...
    items: [
      "Dilarang menggunakan Bayarivo untuk penipuan, pencucian uang, penyalahgunaan identitas, manipulasi transaksi, atau aktivitas yang melanggar hukum.",
      "Bayarivo dapat menunda transaksi, membatasi fitur, atau menonaktifkan akun jika ditemukan aktivitas mencurigakan atau pelanggaran ketentuan.",
    ],
  },
];
  ...
  return (
    <main className="relative overflow-hidden bg-sky-50 text-slate-900">
      ...
      <section className="relative space-y-5 px-4 pb-5 pt-4">
        ...
        <div className="overflow-hidden rounded-[28px] border border-white/70 bg-linear-to-br from-[#126b9a] via-[#126b9a] to-[#126b9a] px-5 py-6 text-white shadow-[0_24px_60px_rgba(15,111,203,0.22)]">
          <div className="max-w-[20rem]">
            ...
            <h1 className="mt-3 text-balance text-[30px] font-black leading-[1.02] tracking-tight">
              Aturan penggunaan layanan Bayarivo.
            </h1>
            <p className="mt-4 text-sm leading-6 text-white/90 text-justify">
              Ketentuan ini menjelaskan cara menggunakan produk digital, saldo, akun agent, program kredit, dan fitur pendampingan marketing di Bayarivo.
            </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h2 className="mt-1 text-xl font-black tracking-tight text-slate-950">
                Bayarivo menjaga transaksi tetap aman, jelas, dan bertanggung jawab
              </h2>
            </div>
          </div>
      ...
      <section className="relative px-4 pb-4">
        <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
          <div className="flex items-start gap-3">
            ...
            <h2 className="mt-1 text-xl font-black tracking-tight text-slate-950">
                Dengan memakai layanan Bayarivo, Anda menyetujui ketentuan penggunaan ini
              </h2>
            </div>
          </div>
          ...
          <div className="mt-4 space-y-3 text-sm leading-6 text-slate-600 text-justify">
            <p>
              Bayarivo dapat memperbarui ketentuan ini mengikuti perubahan fitur, proses layanan, dan kebutuhan keamanan.
              Versi terbaru akan dipublikasikan pada halaman ini.
            </p>
            <p>
              Pengguna dianggap menyetujui perubahan ketentuan apabila tetap menggunakan akun dan layanan Bayarivo setelah pembaruan dipublikasikan.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative px-4 pb-10">
        <aside className="rounded-[28px] border border-sky-200 bg-linear-to-r from-[#126b9a] via-[#126b9a] to-[#126b9a] p-5 text-white shadow-[0_24px_60px_rgba(15,111,203,0.22)]">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h2 className="mt-2 text-xl font-black tracking-tight">
                Hubungi Bayarivo jika Anda membutuhkan bantuan terkait akun, transaksi, atau ketentuan layanan
              </h2>
            </div>
          </div>
          ...
          <div className="mt-6 flex gap-3">
            <Link
              ...
              className="inline-flex h-12 flex-1 items-center justify-center rounded-full bg-white px-4 text-center text-sm font-semibold text-[#126b9a]! visited:text-[#126b9a]! hover:bg-sky-50 hover:text-[#126b9a]!"
            >
              WhatsApp
            </Link>
            <Link
