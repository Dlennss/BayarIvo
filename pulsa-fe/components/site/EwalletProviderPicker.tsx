    ...
    <div className="space-y-3 pb-28">
      <section className="overflow-hidden rounded-[28px] border border-emerald-950/5 bg-linear-to-br from-white via-emerald-50/80 to-lime-50/70 p-3 shadow-[0_18px_42px_rgba(6,78,59,0.12)]">
        <div className="flex items-center gap-3">
          <span className="grid h-13 w-13 shrink-0 place-items-center rounded-[20px] bg-linear-to-br from-[#163d52] to-[#16a34a] text-lime-200 shadow-[0_14px_28px_rgba(5,46,38,0.18)]">
      ...
      <section className="overflow-hidden rounded-[30px] border border-emerald-950/5 bg-linear-to-br from-white via-[#f8fffb] to-emerald-50/85 p-3 shadow-[0_18px_42px_rgba(6,78,59,0.12)]">
        <div className="flex items-center justify-between gap-3 px-1 pb-3 pt-1">
          ...
          {selectedItem ? (
            <span className="max-w-24 truncate rounded-full bg-[#163d52] px-3 py-1.5 text-[10px] font-black text-lime-200 shadow-[0_10px_18px_rgba(5,46,38,0.16)]">
              {selectedItem.title}
            </span>
          ) : null}
        </div>
              ...
              return (
                <button
                  ...
                  className={`group relative min-h-[104px] overflow-hidden rounded-[23px] border px-2.5 pb-2 pt-2.5 text-left transition duration-300 hover:-translate-y-0.5 ${
                    selected
                      ? "border-lime-300 bg-[#163d52] shadow-[0_18px_34px_rgba(5,46,38,0.24)] ring-2 ring-lime-200/70"
                ...
                >
                  ...
                  {selected ? (
                    <span className="absolute right-2 top-2 z-10 grid h-5.5 w-5.5 place-items-center rounded-full bg-lime-300 text-[#163d52] shadow-[0_8px_16px_rgba(0,0,0,0.18)]">
        ...
        <Link
          ...
          className={`group relative mt-4 flex h-13 items-center justify-center gap-2 overflow-hidden rounded-[22px] text-sm font-black transition ${
            selectedItem
              ? "bg-linear-to-r from-[#163d52] via-[#163d52] to-[#163d52] text-white shadow-[0_18px_34px_rgba(5,46,38,0.28)] ring-1 ring-white/20"
        ...
        >
          ...
          <span className="relative grid h-6 w-6 place-items-center rounded-full bg-lime-300 text-[#163d52] shadow-[0_8px_16px_rgba(0,0,0,0.18)] transition group-hover:translate-x-0.5">
