      ...
      <div className="space-y-4 px-4 py-4">
        ...
        <div className="flex items-stretch gap-2">
          ...
          <button
            ...
            className="inline-flex h-auto min-w-20 items-center justify-center rounded-md bg-linear-to-r from-[#126b9a] to-[#126b9a] px-4 text-sm font-semibold text-white shadow-[0_8px_20px_rgba(15,111,203,0.24)] transition hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-40"
          >
            Beli
          </button>
        </div>
