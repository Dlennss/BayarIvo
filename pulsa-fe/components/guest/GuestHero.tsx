...
export function GuestHero({ isLoggedIn = false }: GuestHeroProps) {
  return (
    <section className="sticky top-0 z-30 border-b border-white/10 bg-linear-to-r from-[#163d52] via-[#126b9a] to-[#10b981] px-5 pb-2 pt-2 text-white shadow-[0_10px_24px_rgba(6,78,59,0.22)] backdrop-blur-sm">
