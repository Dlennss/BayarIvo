      ...
      <div className="brand-categories rounded-[24px] border border-emerald-950/5 bg-linear-to-br from-white via-emerald-50/70 to-lime-50/80 p-2.5 shadow-[0_18px_38px_rgba(6,78,59,0.12)]">
        <div className={showAll ? "grid grid-cols-3 gap-2.5" : "grid grid-cols-3 gap-2.5"}>
          ...
          {!showAll ? (
            ...
            >
              <div className="grid h-11 w-11 place-items-center rounded-2xl bg-linear-to-br from-[#163d52] via-[#126b9a] to-[#f4ce73] text-white shadow-[0_12px_26px_rgba(6,78,59,0.26)] ring-1 ring-white/40 transition-transform duration-300 group-hover:scale-105">
                <LayoutGrid className="h-4.5 w-4.5" strokeWidth={2.2} />
              </div>
              <span className="line-clamp-2 px-1 text-[10px] font-black leading-tight text-[#163d52]">
                Lainnya
              </span>
            </Link>
          ) : null}
