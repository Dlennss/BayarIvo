  ...
  if (plnStyle) {
    return (
      <button
        ...
        disabled={!canBuy}
        className="group relative w-full overflow-hidden rounded-[24px] bg-[#163d52] px-4 py-4 text-left text-white shadow-[0_16px_32px_rgba(5,46,38,0.22)] ring-1 ring-lime-200/20 transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_40px_rgba(5,46,38,0.28)] disabled:cursor-not-allowed disabled:opacity-60"
      >
