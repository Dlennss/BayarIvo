...
export function GuestProductGameCard({
  ...
  return (
    <button
      ...
      disabled={!canBuy}
      className="group relative min-h-[116px] w-full overflow-hidden rounded-[22px] border border-emerald-100/70 bg-linear-to-br from-[#163d52] via-[#126b9a] to-[#22c55e] p-3 text-left text-white shadow-[0_16px_34px_rgba(6,78,59,0.18)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_42px_rgba(6,78,59,0.24)] disabled:cursor-not-allowed disabled:opacity-60"
    >
