...
export function EMoneyBrandFlow({ items, isLoggedIn, authToken, buyerRole, initialDest = "" }: EMoneyBrandFlowProps) {
  ...
  return (
    <div className="mt-2 space-y-4">
      {brandName ? (
        <section className="overflow-hidden rounded-[26px] border border-emerald-950/10 bg-linear-to-br from-[#163d52] via-[#126b9a] to-[#b8f138] p-4 text-white shadow-[0_18px_42px_rgba(5,46,38,0.22)]">
          <div className="flex items-center gap-4">
            <div className="grid h-18 w-18 shrink-0 place-items-center rounded-[24px] bg-white p-3 shadow-[0_14px_30px_rgba(5,46,38,0.18)]">
              {brandLogo?.src ? (
                ...
                <Wallet className="h-8 w-8 text-[#126b9a]" />
              )}
            </div>
            <div className="min-w-0 flex-1">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-lime-200">Bayarivo E-Wallet</p>
