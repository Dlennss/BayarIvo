...
export function ServiceDirectory({ mode = "guest", role }: ServiceDirectoryProps) {
  ...
  return (
    <section className="space-y-3 pb-24">
      <div className="sticky top-0 z-20 -mx-4 bg-[#f3f7fa]/92 px-4 pb-3 pt-3 backdrop-blur-xl">
        <label className="flex h-13 items-center gap-3 rounded-[22px] border border-emerald-950/10 bg-white px-4 shadow-[0_12px_30px_rgba(6,78,59,0.08)]">
          <Search className="h-5 w-5 shrink-0 text-[#126b9a]" />
          <input
            value={query}
          ...
          <div className="flex w-max gap-2">
            <button
              ...
              className={cn(
                ...
                activeGroup === "semua"
                  ? "bg-[#163d52] text-white shadow-[0_10px_20px_rgba(5,46,38,0.22)]"
      ...
      <div className="overflow-hidden rounded-[24px] border border-lime-200/70 bg-linear-to-r from-[#fff8e7] via-white to-[#f3f7fa] px-4 py-3 shadow-[0_12px_28px_rgba(6,78,59,0.08)]">
        <div className="flex items-center gap-3">
          <div className="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-orange-100 text-orange-500">
            <Zap className="h-5 w-5" />
          </div>
          <div>
            <p className="text-sm font-black text-[#163d52]">Transaksi makin praktis</p>
      ...
      {filteredGroups.length > 0 ? (
        filteredGroups.map((group) => (
          ...
          >
            <div className="mb-4 flex items-center gap-2">
              ...
              <span className="rounded-full bg-lime-100 px-2 py-1 text-[10px] font-black text-[#126b9a]">
        ...
        <div className="rounded-[26px] border border-dashed border-emerald-200 bg-white p-8 text-center shadow-[0_14px_34px_rgba(6,78,59,0.08)]">
          <BookOpen className="mx-auto h-8 w-8 text-[#126b9a]" />
      ...
      <Link
        href={mode === "user" ? "/user" : "/"}
        prefetch={false}
        className="group flex items-center justify-between rounded-[24px] border border-emerald-300/30 bg-[#163d52] px-4 py-4 text-white shadow-[0_16px_34px_rgba(5,46,38,0.22)]"
      >
        <span>
        ...
        <span className="grid h-10 w-10 place-items-center rounded-2xl border border-white/70 bg-lime-300 text-[#163d52] shadow-[0_8px_18px_rgba(163,230,53,0.28)] transition group-hover:translate-x-0.5">
