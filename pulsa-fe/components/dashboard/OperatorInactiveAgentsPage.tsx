...
export default function OperatorInactiveAgentsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f3f7fa] p-3 text-slate-950 sm:p-5 lg:p-7">
      <div className="mx-auto w-full max-w-7xl space-y-5">
        <header className="overflow-hidden rounded-[28px] bg-[linear-gradient(135deg,#163d52,#087b52_58%,#35b945)] p-5 text-white shadow-[0_20px_44px_rgba(6,78,59,0.16)] sm:p-7">
