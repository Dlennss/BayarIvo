...
export function NavItem({ href, label, onClick, variant = "light" }: Props) {
  ...
  return (
      ...
      className={[
        ...
        active
          ? isDark
            ...
            : "border-[#163d52] bg-white text-[#163d52] shadow-[0_10px_20px_rgba(6,78,59,0.10)]"
          : isDark
    ...
    >
      ...
      {active ? (
        <span className={`inline-flex h-6 w-6 items-center justify-center rounded-full ${isDark ? "bg-[#163d52] text-white" : "bg-[#163d52] text-white"}`}>
