...
function ReviewSignaturePad({
  ...
  return (
    <div className="rounded-[24px] border border-emerald-300 bg-[linear-gradient(180deg,#ffffff_0%,#f3fff9_100%)] p-4 text-center shadow-[0_12px_26px_rgba(4,120,87,0.10)]">
      ...
      <p className={hasInk ? "mt-1 text-[9px] font-black text-[#126b9a]" : "mt-1 text-[9px] font-black text-slate-400"}>
            ...
            {!statusEditorOpen ? (
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button type="button" onClick={() => void changeCreditOperationalStatus()} disabled={statusBusy} className="inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-[#163d52] text-[10px] font-black text-white disabled:opacity-60">
      ...
      <div className="grid gap-2 xl:grid-cols-[160px_minmax(260px,1fr)_210px] xl:items-stretch">
        ...
        <div className={`grid min-w-0 grid-cols-1 gap-2 ${isMarketingReview ? "" : mode === "analyst" ? "min-[390px]:grid-cols-3 xl:grid-cols-1" : "min-[390px]:grid-cols-2 xl:grid-cols-1"}`}>
          <button
            ...
            className="inline-flex h-11 min-w-0 items-center justify-center gap-2 rounded-xl bg-[linear-gradient(135deg,#126b9a,#16a34a)] px-3 text-[11px] font-black leading-3 text-white shadow-[0_10px_18px_rgba(5,150,105,0.18)] transition hover:-translate-y-0.5 disabled:translate-y-0 disabled:bg-none disabled:bg-slate-200 disabled:text-slate-500 disabled:shadow-none"
