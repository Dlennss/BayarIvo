...
export function OperatorCreditPaymentsPage({ applications }: { applications: AgentCreditApplication[] }) {
  ...
  const rows = useMemo<PaymentRow[]>(() => applications.flatMap((application) => {
    ...
    const agentName = application.agent_name || application.member_name || (typeof applicantName === "string" ? applicantName : "") || "Agent Bayarivo";
  ...
  return (
    <main className="min-h-screen bg-[#eef7f2] p-3 text-slate-950 sm:p-6 lg:p-8">
      <div className="mx-auto w-full max-w-7xl space-y-4 sm:space-y-6">
        <header className="rounded-[26px] bg-[linear-gradient(135deg,#163d52,#126b9a,#22c55e)] p-5 text-white shadow-[0_22px_50px_rgba(4,120,87,0.18)] sm:p-7">
