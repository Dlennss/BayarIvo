  ...
  return (
    <div className="rounded-[22px] border border-emerald-100 bg-[linear-gradient(135deg,#ecfdf5,#ffffff)] p-3">
      <div className="flex items-center gap-3">
        <span className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-emerald-100 text-[#126b9a]">
        ...
        <span className="hidden rounded-full bg-emerald-100 px-3 py-1 text-[9px] font-black uppercase text-[#126b9a] sm:inline-flex">
          4/4
        </span>
      </div>
    </div>
    ...
    <div className="rounded-[24px] border border-emerald-100 bg-[linear-gradient(135deg,#f8fffb_0%,#ffffff_48%,#ecfdf5_100%)] p-3 shadow-[0_12px_26px_rgba(4,120,87,0.06)]">
      <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
        <div className="flex min-w-0 items-start gap-3">
          <span className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-emerald-50 text-[#126b9a] ring-1 ring-emerald-100">
        ...
        <span className="rounded-full bg-emerald-100 px-3 py-1 text-[9px] font-black uppercase text-[#126b9a]">
        ...
        {editableFields.map((field) => {
          ...
          return (
            <label
              ...
              className={
                picked
                  ? "group flex min-h-20 cursor-pointer items-center gap-3 overflow-hidden rounded-2xl border border-emerald-300 bg-white p-2 transition hover:border-[#126b9a] hover:bg-emerald-50/40"
                  : "flex min-h-20 cursor-pointer items-center gap-3 rounded-2xl border border-dashed border-emerald-200 bg-white px-3 py-2 transition hover:border-[#126b9a] hover:bg-emerald-50"
              }
            >
              {picked ? (
                <>
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="mt-1 inline-flex items-center gap-1 rounded-full bg-emerald-100 px-2 py-1 text-[8px] font-black uppercase text-[#126b9a]">
      ...
      <button
        ...
        className="mt-3 inline-flex h-11 w-full items-center justify-center gap-2 rounded-2xl bg-[linear-gradient(135deg,#126b9a,#16a34a)] text-xs font-black text-white shadow-[0_12px_22px_rgba(4,120,87,0.16)] transition hover:-translate-y-0.5 disabled:translate-y-0 disabled:bg-none disabled:bg-slate-200 disabled:text-slate-500 disabled:shadow-none"
      >
...
export function MasterAgentCreditApplicationList({
  ...
  async function exportPdfReport() {
    ...
    doc.setFontSize(10);
    doc.text(`Bayarivo - ${reportSubtitle}`, 40, 54);
      ...
      <html>
        <head>
          ...
          <style>
            ...
            header { border-bottom: 4px solid #126b9a; padding-bottom: 16px; margin-bottom: 18px; }
            ...
            th { background: #126b9a; color: white; text-align: left; padding: 8px; }
        ...
        <body>
          <header>
            ...
            <p>Bayarivo - ${escapeHTML(reportSubtitle)}</p>
  ...
  return (
    <section className="min-w-0 overflow-hidden rounded-[22px] border border-slate-200 bg-white p-3 shadow-[0_18px_42px_rgba(15,23,42,0.06)] sm:rounded-[28px] sm:p-5">
      <div className="flex min-w-0 flex-col items-start gap-3">
        ...
        <span className="inline-flex w-fit items-center rounded-full bg-[linear-gradient(135deg,#126b9a,#8bdc24)] px-4 py-2 text-[10px] font-black uppercase tracking-[0.12em] text-white shadow-[0_12px_28px_rgba(5,122,69,0.18)]">
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="grid grid-cols-3 gap-2 sm:flex sm:items-center">
              ...
              <button
                ...
                className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl bg-[linear-gradient(135deg,#126b9a,#84cc16)] px-3 text-[11px] font-black text-white shadow-[0_12px_24px_rgba(4,120,87,0.18)] transition disabled:cursor-not-allowed disabled:opacity-50"
              >
