  ...
  return (
    <div className={isEditing ? "grid gap-5 xl:grid-cols-[minmax(0,1fr)_380px]" : "block"}>
      <section className="overflow-hidden rounded-lg border border-emerald-200 bg-white shadow-[0_16px_36px_rgba(6,78,59,0.08)]">
        <div className="flex items-center justify-between gap-4 bg-[linear-gradient(135deg,#163d52,#075f46)] px-4 py-4 text-white sm:px-5">
      ...
      <form onSubmit={submit} className="rounded-[28px] border border-emerald-100 bg-[linear-gradient(180deg,#ffffff_0%,#f3fff8_100%)] p-4 shadow-[0_18px_42px_rgba(6,78,59,0.08)] sm:p-5">
        ...
        <button type="submit" disabled={saving} className="mt-4 flex h-12 w-full items-center justify-center gap-2 rounded-[20px] bg-[linear-gradient(135deg,#163d52,#126b9a,#84cc16)] text-sm font-black text-white shadow-[0_16px_30px_rgba(5,150,105,0.20)] disabled:opacity-50">
