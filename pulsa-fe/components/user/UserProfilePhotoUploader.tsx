...
export function UserProfilePhotoUploader({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        <span className="relative grid h-20 w-20 overflow-hidden rounded-[26px] bg-white text-2xl font-black text-[#126b9a] shadow-[0_16px_34px_rgba(6,78,59,0.18)]">
          {photo ? (
        ...
        <span className="absolute -bottom-1 -right-1 grid h-8 w-8 place-items-center rounded-full border-3 border-[#126b9a] bg-white text-[#126b9a] shadow-[0_8px_18px_rgba(6,78,59,0.18)]">
