...
const accessibleActionButtonClass =
  "inline-flex h-10 shrink-0 items-center justify-center gap-1.5 rounded-2xl border border-[#163d52] bg-[#163d52] px-3.5 text-[11px] font-black text-white! shadow-[0_10px_20px_rgba(6,78,59,0.18)] transition visited:text-white! hover:-translate-y-0.5 hover:bg-[#163d52] hover:text-white! focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-200 active:translate-y-0";
  ...
  return (
    <section>
      <Link
        ...
        prefetch={false}
        className="group block overflow-hidden rounded-lg border border-[#163d52]/10 bg-linear-to-r from-[#ecfdf5] via-white to-[#f3f7fa] p-5 shadow-[0_10px_24px_rgba(6,78,59,0.08)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(6,78,59,0.12)]"
      >
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#126b9a]">Shortcut Cepat</p>
          ...
          <div className="grid h-11 w-11 place-items-center rounded-lg bg-[#dcfce7] text-[#126b9a] transition group-hover:scale-105">
...
export function UserApiCTA() {
  return (
    <section>
      <div className="relative overflow-hidden rounded-[28px] bg-[#163d52] p-4 text-white shadow-[0_20px_44px_rgba(5,46,38,0.24)] ring-1 ring-lime-200/15">
        ...
        <div className="relative">
          ...
          <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
            <Link
              href="/docs"
              prefetch={false}
              className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl bg-lime-300 px-3 text-sm font-black text-[#163d52] shadow-[0_12px_24px_rgba(163,230,53,0.22)] transition hover:bg-lime-200"
            >
...
export function UserWeeklyPromo() {
  return (
    <section>
      <div className="h-44 rounded-lg bg-linear-to-r from-[#163d52] via-[#126b9a] to-[#f4ce73] p-5 text-white shadow-sm">
    ...
    <section className="space-y-3">
      ...
      <div className="rounded-[22px] border border-emerald-950/10 bg-white p-4 shadow-[0_12px_30px_rgba(6,78,59,0.08)]">
        <div className="flex items-center gap-3">
          <div className="relative grid h-12 w-12 shrink-0 place-items-center rounded-[18px] bg-emerald-50 text-[#126b9a] ring-1 ring-emerald-100">
      ...
      <div className="rounded-[22px] border border-emerald-950/10 bg-white p-4 shadow-[0_12px_30px_rgba(6,78,59,0.08)]">
        <div className="flex items-center gap-3">
          <div className="grid h-12 w-12 shrink-0 grid-cols-2 gap-1 rounded-[18px] bg-emerald-50 p-2 ring-1 ring-emerald-100">
            <span className="grid place-items-center rounded-lg bg-linear-to-br from-[#163d52] to-[#126b9a] text-white">
              <Smartphone className="h-3.5 w-3.5" strokeWidth={2.5} />
            </span>
            <span className="grid place-items-center rounded-lg bg-linear-to-br from-[#126b9a] to-[#f4ce73] text-white">
            ...
            <span className="grid place-items-center rounded-lg bg-linear-to-br from-[#163d52] to-[#06b6d4] text-white">
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="rounded-[22px] border border-emerald-950/10 bg-white p-4 shadow-[0_12px_30px_rgba(6,78,59,0.08)]">
        <div className="flex items-center gap-3">
          <div className="relative grid h-12 w-12 shrink-0 place-items-center rounded-[18px] bg-emerald-50 text-[#126b9a] ring-1 ring-emerald-100">
            <span className="absolute -right-1 -top-1 grid h-5 w-5 place-items-center rounded-full bg-lime-300 text-[#163d52] ring-2 ring-white">
...
export function UserAboutSection() {
  return (
    <section>
      <div className="rounded-lg border border-[#163d52]/10 bg-white px-4 py-6 shadow-[0_10px_24px_rgba(6,78,59,0.08)]">
        <h3 className="text-lg leading-tight font-bold text-slate-900">Bayarivo - Solusi Digital untuk Kebutuhan Sehari-hari</h3>
        <p className="mt-3 text-sm leading-relaxed text-slate-600 text-justify">
          Bayarivo hadir sebagai platform digital untuk memenuhi kebutuhan transaksi online Anda. Tersedia pembayaran praktis dan harga kompetitif. 
          <span><Link href="/tentang" prefetch={false} className="text-[#126b9a]! hover:underline!">
            Selengkapnya
          </Link></span>
        </p>
      </div>
