...
export function UserHero({ user, profile }: UserHeroProps) {
  ...
  return (
    <section className="sticky top-0 z-30 border-b border-white/10 bg-linear-to-r from-[#126b9a] via-[#126b9a] to-[#126b9a] px-5 pb-2 pt-2 text-white shadow-[0_10px_24px_rgba(15,111,203,0.20)] backdrop-blur-sm">
        ...
        <div className="min-w-0 flex-1 pr-2">
          {isLoggedIn ? (
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-2.5 py-1 backdrop-blur-sm">
              ...
              <span className="text-sm font-black tracking-[0.2em] text-white/95">BAYARIVO</span>
            </div>
          )}
        </div>
