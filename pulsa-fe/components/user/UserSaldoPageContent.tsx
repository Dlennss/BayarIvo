...
export function UserSaldoPageContent({ saldo, userCode, showCredit = false }: UserSaldoPageContentProps) {
  ...
  const actions = [
    { label: "Isi Saldo", sub: "Tambah dana", href: "/user/account/topup", icon: Plus, tone: "bg-lime-100 text-[#126b9a]" },
    { label: "Kirim", sub: "Ke pengguna", href: "/user/saldo/kirim", icon: ArrowUpRight, tone: "bg-emerald-100 text-[#126b9a]" },
  ...
  const topupMethods = [
    { title: "Transfer Bank", desc: "BCA, BRI, BNI, dan Mandiri", href: "/user/account/topup", icon: Landmark, tone: "bg-emerald-50 text-[#126b9a]" },
  ...
  return (
    <div className="space-y-3.5">
        ...
        <div className="relative">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-[11px] font-semibold text-white/78">Siap dipakai untuk semua transaksi Bayarivo</p>
            </div>
          ...
          <div className="mt-5 flex items-center justify-between border-t border-white/15 pt-3">
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-lime-100">Bayarivo Wallet</p>
      ...
      <Link href="/user/account/mutasi" className="flex items-center gap-3 rounded-[22px] border border-emerald-200 bg-emerald-50/90 px-4 py-3 text-[#126b9a] shadow-[0_10px_24px_rgba(4,120,87,0.07)]">
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="mt-0.5 block text-[10px] font-semibold text-[#126b9a]/70">Setiap transaksi dijaga dengan PIN dan verifikasi.</span>
        </span>
      ...
      <section className="rounded-[24px] border border-emerald-950/5 bg-white px-4 py-4 shadow-[0_16px_36px_rgba(6,78,59,0.08)]">
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4">
          <div className="flex min-w-0 items-center gap-3">
            <span className="grid h-12 w-12 shrink-0 place-items-center rounded-full bg-emerald-50 text-[#126b9a]">
      ...
      <section className="overflow-hidden rounded-[24px] border border-emerald-950/5 bg-white shadow-[0_16px_36px_rgba(6,78,59,0.08)]">
        <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3.5">
          ...
          <Link href="/user/account/topup" className="text-[10px] font-black text-[#126b9a]">Lihat semua</Link>
        </div>
      ...
      <section className="overflow-hidden rounded-[24px] border border-emerald-950/5 bg-white shadow-[0_16px_36px_rgba(6,78,59,0.08)]">
        ...
        <div className="grid min-h-[220px] place-items-center px-6 py-8 text-center">
          <div>
            <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-emerald-50 text-[#126b9a] ring-1 ring-emerald-100">
            ...
            <Link href="/user/account/topup" className="mt-5 inline-flex h-10 items-center justify-center rounded-2xl bg-lime-100 px-4 text-xs font-black text-[#126b9a]">
              Isi Saldo Sekarang
            </Link>
          </div>
        </div>
