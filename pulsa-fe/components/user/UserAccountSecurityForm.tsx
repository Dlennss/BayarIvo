...
export function UserAccountSecurityForm({ authToken }: Props) {
  ...
  return (
    <div className="space-y-4">
      <section className="overflow-hidden rounded-[28px] bg-[linear-gradient(135deg,#163d52,#047857_62%,#4dcf38)] p-5 text-white shadow-[0_18px_40px_rgba(6,78,59,0.18)]">
      ...
      <form onSubmit={submit} className="overflow-hidden rounded-[28px] border border-emerald-100 bg-white shadow-[0_16px_38px_rgba(6,78,59,0.08)]">
        <div className="flex items-center gap-3 border-b border-slate-100 px-5 py-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs font-semibold text-slate-500">Perbarui password akun Bayarivo.</p>
          </div>
        </div>
        ...
        <div className="space-y-4 p-5">
          ...
          <button type="submit" disabled={saving} className="inline-flex h-13 w-full items-center justify-center gap-2 rounded-2xl bg-[linear-gradient(90deg,#126b9a,#16a34a)] px-5 text-sm font-black text-white shadow-[0_12px_24px_rgba(5,150,105,0.22)] disabled:cursor-not-allowed disabled:opacity-60">
