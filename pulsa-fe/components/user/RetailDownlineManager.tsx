    ...
    <div className="space-y-4">
      <section className="relative overflow-hidden rounded-[30px] bg-[linear-gradient(135deg,#052e26_0%,#047857_58%,#84cc16_145%)] p-5 text-white shadow-[0_20px_44px_rgba(4,120,87,0.22)]">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <span className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-white text-[#126b9a] shadow-[0_10px_22px_rgba(0,0,0,0.10)]">
        ...
        <div className="flex items-center justify-between gap-3 border-b border-slate-100 bg-[linear-gradient(135deg,#f8fffb,#eefbf4)] px-4 py-4">
          ...
          {canCreate ? (
            <button
              ...
              className="inline-flex h-10 shrink-0 items-center gap-2 rounded-2xl bg-[#163d52] px-3 text-xs font-black text-white shadow-[0_10px_20px_rgba(6,78,59,0.18)] transition hover:bg-[#163d52]"
            >
        ...
        <div className="space-y-3 p-4">
          ...
          {!loading && items.length === 0 ? (
            <div className="grid min-h-[180px] place-items-center rounded-[24px] border border-dashed border-emerald-200 bg-emerald-50/50 px-4 text-center">
              <div>
                <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-white text-[#126b9a] shadow-sm">
            ...
            <div key={item.id} className="rounded-[22px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fffb_100%)] px-4 py-3 shadow-[0_8px_20px_rgba(15,23,42,0.04)]">
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="text-right">
                  ...
                  <div className="mt-2 text-sm font-black text-[#126b9a]">Rp {fmtIDR(item.saldo)}</div>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 p-4 backdrop-blur-[2px]">
          <div className="max-h-[calc(100dvh-2rem)] w-full max-w-md overflow-y-auto rounded-[30px] bg-white p-5 shadow-[0_18px_46px_rgba(15,23,42,0.24)] md:w-[390px] md:max-w-none">
            <div className="flex items-start justify-between gap-4 border-b border-slate-100 pb-4">
              <div>
                <div className="text-[10px] font-black uppercase tracking-[0.22em] text-[#126b9a]">Tambah Downline</div>
            ...
            <div className="space-y-4 pt-5">
              ...
              <form className="grid gap-3" onSubmit={submit}>
                ...
                <button className="mt-1 inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-[#163d52] text-sm font-black text-white shadow-[0_12px_24px_rgba(6,78,59,0.18)] hover:bg-[#163d52] disabled:opacity-70" disabled={saving} type="submit">
