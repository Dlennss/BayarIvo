      ...
      {hasNextPage && page === 1 ? (
        <div className="flex justify-center">
          <button
            ...
            className="inline-flex w-full justify-center rounded-md bg-[#126b9a] px-4 py-2 text-sm font-semibold text-white! shadow-sm transition hover:bg-[#0a5dad] hover:text-white!"
          >
            Lainnya
          </button>
        </div>
