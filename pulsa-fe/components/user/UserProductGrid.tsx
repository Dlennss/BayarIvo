...
function UserProductCard({
  ...
  if (emoneyStyle) {
    ...
    return (
      ...
      >
        <div className="absolute inset-x-0 top-0 h-1.5 bg-linear-to-r from-[#163d52] via-[#126b9a] to-[#b8f138]" />
        ...
        <div className="relative flex h-full min-h-30 flex-col justify-between gap-3">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              <p className="text-[10px] font-black uppercase tracking-[0.16em] text-[#126b9a]">Nominal Top Up</p>
          ...
          <div className="space-y-2">
            <div>
              ...
              <p className="text-sm font-black text-[#163d52]">
                {canBuy ? formatRupiah(finalPrice) : (buyBlockedLabel || "Lengkapi dulu")}
              </p>
            </div>
            <span className="inline-flex h-8 w-full items-center justify-center rounded-2xl bg-[#163d52] px-3 text-xs font-black text-white shadow-[0_10px_20px_rgba(5,46,38,0.18)] transition group-hover:bg-[#126b9a]">
          ...
          <div className="max-h-[92vh] w-full max-w-md overflow-y-auto rounded-[28px] bg-white p-5 shadow-[0_18px_46px_rgba(15,23,42,0.24)] md:w-97.5 md:max-w-none">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <Link
                ...
                className="inline-flex h-10 items-center justify-center rounded-2xl bg-linear-to-r from-[#126b9a] to-[#126b9a] px-4 text-sm font-semibold text-white! visited:text-white! hover:text-white!"
              >
                Masuk
              </Link>
              <Link
