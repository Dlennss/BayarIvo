      ...
      <form onSubmit={handleSubmit} className="mt-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            type="submit"
            disabled={loading}
            className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl bg-linear-to-r from-[#126b9a] to-[#126b9a] px-4 text-sm font-semibold text-white shadow-[0_8px_20px_rgba(15,111,203,0.24)] disabled:cursor-not-allowed disabled:opacity-60"
          >
