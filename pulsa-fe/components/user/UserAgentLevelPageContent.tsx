...
const kilatLevels = [
  {
    ...
    benefits: [
      ["Limit sampai Rp 500.000", "Agent baru mulai dari limit dasar Bayarivo", WalletCards],
  ...
  },
  {
    ...
    desc: "Level tertinggi Bayarivo setelah agent menyelesaikan 5 pengajuan tepat waktu. Limit maksimal Rp 2.000.000.",
    benefits: [
  ...
  return (
    <div className="mx-auto w-full max-w-md pb-24">
      <section className={`relative min-h-[520px] overflow-hidden bg-linear-to-br ${activeLevel.bg} px-4 pt-5 text-slate-700`}>
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="truncate text-lg font-semibold text-slate-700">Bayarivo Level</h1>
          </div>
        </div>
      ...
      <div className="-mt-24 px-3">
        ...
        <section className="mt-3 rounded-[24px] border border-emerald-100 bg-emerald-50 p-4 text-[#126b9a]">
          <div className="flex items-center gap-3">
            <ShieldCheck className="h-8 w-8 shrink-0" strokeWidth={2.5} />
            <div>
              <p className="text-sm font-black">Naik Level Bertahap</p>
              <p className="mt-1 text-[11px] font-semibold leading-5 text-[#126b9a]/75">Level naik dari jumlah pengajuan yang sudah lunas tepat waktu: 3 kali menjadi Plus, 5 kali menjadi Elite.</p>
            </div>
          </div>
        </section>
      </div>
