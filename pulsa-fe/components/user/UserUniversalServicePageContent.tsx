...
export function UserUniversalServicePageContent({ serviceSlug }: { serviceSlug: string }) {
  ...
  function checkHpPostpaidBill() {
    ...
    const nextBill = {
      customerName: "Pelanggan Bayarivo",
            ...
            <div className="space-y-5 p-4">
              ...
              <section className="rounded-[24px] border border-emerald-100 bg-[linear-gradient(135deg,#f4fff8,#ffffff)] p-4 shadow-[0_12px_26px_rgba(0,122,61,0.08)]">
                ...
                <button
                  ...
                  className="mt-4 flex h-[58px] w-full items-center justify-center gap-2 rounded-[18px] bg-[linear-gradient(135deg,#163d52,#008a42,#65c82f)] text-base font-extrabold text-white shadow-[0_16px_28px_rgba(0,122,61,0.24)] disabled:bg-none disabled:bg-slate-200 disabled:text-slate-500"
                >
        ...
        <header className="relative overflow-hidden bg-[linear-gradient(140deg,#052e26_0%,#047857_64%,#38b94d_115%)] px-4 pb-10 pt-5 text-white shadow-[0_16px_36px_rgba(5,46,38,0.22)]">
          <div className="mx-auto w-full max-w-md">
            ...
            <div className="mt-7 flex items-center gap-4">
              <span className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-white text-[#126b9a] shadow-[0_12px_26px_rgba(0,0,0,0.16)]">
        ...
        <div className="relative z-10 mx-auto -mt-4 w-full max-w-md space-y-4 px-3 min-[390px]:px-4">
          <section className="overflow-hidden rounded-[24px] border border-emerald-100 bg-white shadow-[0_16px_38px_rgba(15,23,42,0.09)]">
            <div className="border-b border-slate-100 px-4 py-5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#126b9a]">Langkah 1</p>
                  <h2 className="mt-1 text-lg font-black">Pilih operator</h2>
                </div>
                <span className="rounded-full bg-emerald-50 px-3 py-1.5 text-[10px] font-black text-[#126b9a]">{hpPostpaidProviders.length} tersedia</span>
              </div>
                  ...
                  return (
                    <button
                      ...
                      className={[
                        ...
                        active
                          ? "border-[#126b9a] bg-emerald-50 shadow-[0_8px_18px_rgba(4,120,87,0.10)] ring-1 ring-[#126b9a]"
                          : "border-slate-200 bg-white hover:border-emerald-300",
                      ].join(" ")}
                    >
                      {active ? <CheckCircle2 className="absolute right-2 top-2 h-4 w-4 text-[#126b9a]" strokeWidth={2.8} /> : null}
            ...
            <div className="px-4 py-5">
              <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#126b9a]">Langkah 2</p>
              <label htmlFor="hp-postpaid-number" className="mt-1 block text-lg font-black">Nomor pelanggan</label>
              <div className="mt-3 flex min-h-14 items-center overflow-hidden rounded-[16px] border border-slate-200 bg-slate-50 transition focus-within:border-[#126b9a] focus-within:bg-white focus-within:ring-4 focus-within:ring-emerald-100">
                <span className="grid h-14 w-12 shrink-0 place-items-center text-[#126b9a]">
              ...
              <div className="mt-4 flex min-h-11 items-center justify-between gap-4 rounded-[14px] bg-slate-50 px-3 py-2">
                ...
                <button
                  ...
                  className={[
                    ...
                    saveNumber ? "bg-[#126b9a]" : "bg-slate-300",
                  ].join(" ")}
                >
              ...
              <button
                ...
                className="mt-5 flex h-14 w-full items-center justify-center gap-2 rounded-[16px] bg-[#126b9a] px-4 text-sm font-black text-white shadow-[0_12px_24px_rgba(4,120,87,0.20)] transition hover:bg-[#036b4e] disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none"
              >
          ...
          {hpBill ? (
            <section className="overflow-hidden rounded-[24px] border border-emerald-100 bg-white shadow-[0_16px_38px_rgba(15,23,42,0.09)]">
              <div className="flex items-center justify-between gap-3 border-b border-slate-100 px-4 py-4">
                <div className="min-w-0">
                  <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#126b9a]">Tagihan Ditemukan</p>
                ...
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-[14px] bg-emerald-50 text-[#126b9a]">
              ...
              <div className="bg-[#163d52] px-4 py-4 text-white">
              ...
              <div className="p-4">
                <div className="flex items-center gap-3 rounded-[16px] border border-emerald-200 bg-emerald-50 px-3 py-3">
                  <span className="grid h-10 w-10 shrink-0 place-items-center rounded-[12px] bg-[#126b9a] text-white">
                    <WalletCards className="h-5 w-5" strokeWidth={2.5} />
                  </span>
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-black text-slate-900">Saldo Bayarivo</p>
                    <p className="text-[10px] font-semibold text-slate-500">Pembayaran dari saldo utama</p>
                  </div>
                  <CheckCircle2 className="h-5 w-5 shrink-0 text-[#126b9a]" strokeWidth={2.7} />
                </div>
                ...
                <button
                  ...
                  className="mt-4 flex h-14 w-full items-center justify-center rounded-[16px] bg-[#126b9a] px-4 text-sm font-black text-white shadow-[0_12px_24px_rgba(4,120,87,0.20)] transition hover:bg-[#036b4e] disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none"
                >
  ...
  return (
    <main className="min-h-screen bg-[#f3f7fa] pb-24">
      <section className="relative overflow-hidden bg-[linear-gradient(135deg,#052e26_0%,#047857_58%,#a3e635_150%)] px-4 pb-9 pt-5 text-white">
        ...
        <div className="relative mx-auto flex w-full max-w-md items-center gap-3">
          ...
          <span className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-white text-[#126b9a] shadow-[0_12px_26px_rgba(0,0,0,0.16)]">
      ...
      <div className="mx-auto -mt-5 w-full max-w-md space-y-4 px-4">
        {completedOrder ? (
          <section className="overflow-hidden rounded-[30px] border border-emerald-100 bg-white shadow-[0_22px_50px_rgba(6,78,59,0.14)]">
            <div className="bg-[linear-gradient(135deg,#163d52,#126b9a,#84cc16)] px-5 py-6 text-center text-white">
              <div className="mx-auto grid h-18 w-18 place-items-center rounded-full bg-white text-[#126b9a] shadow-lg">
            ...
            <div className="space-y-3 p-5">
              ...
              <button
                ...
                className="flex h-12 w-full items-center justify-center gap-2 rounded-[18px] border-2 border-[#126b9a] bg-white text-sm font-black !text-[#126b9a] shadow-[0_10px_20px_rgba(6,78,59,0.08)]"
                style={{ color: "#126b9a" }}
              >
              ...
              <Link
                href="/user/transaksi"
                className="flex h-13 w-full items-center justify-center gap-2 rounded-[20px] border-2 border-[#163d52] bg-[linear-gradient(135deg,#064e3b_0%,#047857_72%,#55c72f_145%)] text-sm font-black !text-white shadow-[0_14px_28px_rgba(6,78,59,0.20)]"
                style={{ color: "#ffffff" }}
              >
          ...
          <>
            <section className="rounded-[28px] border border-emerald-950/5 bg-white p-4 shadow-[0_18px_42px_rgba(6,78,59,0.10)]">
              ...
              <div className="flex h-14 overflow-hidden rounded-[20px] border border-emerald-200 bg-[#fbfffd] focus-within:border-[#126b9a] focus-within:ring-4 focus-within:ring-emerald-100">
                <span className="grid w-14 shrink-0 place-items-center border-r border-emerald-100 text-[#126b9a]">
                  ID
                </span>
                <input
                  value={destination}
            ...
            <section className="rounded-[28px] border border-emerald-950/5 bg-white p-4 shadow-[0_18px_42px_rgba(6,78,59,0.10)]">
              <div className="mb-3 flex items-center justify-between">
                ...
                <span className="rounded-full bg-lime-100 px-3 py-1 text-[10px] font-black text-[#126b9a]">Tersedia</span>
              </div>
                ...
                {service.providers.map((provider) => {
                  ...
                  return (
                    <button
                      ...
                      className={
                        active
                          ? "relative min-h-[104px] rounded-[24px] border border-[#126b9a] bg-emerald-50 p-2.5 text-center shadow-[0_16px_30px_rgba(4,120,87,0.15)]"
                    ...
                    >
                      {active ? <CheckCircle2 className="absolute right-2 top-2 h-4 w-4 text-[#126b9a]" /> : null}
                ...
                {service.products.map((product, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={
                        active
                          ? "relative overflow-hidden rounded-[22px] border border-[#126b9a] bg-[#ecfdf5] px-3 py-4 text-left shadow-[0_14px_26px_rgba(4,120,87,0.13)]"
                          : "rounded-[22px] border border-slate-200 bg-white px-3 py-4 text-left shadow-sm"
                      }
                    >
                      {active ? <Sparkles className="absolute right-3 top-3 h-4 w-4 text-[#126b9a]" /> : null}
                      <span className="block pr-5 text-sm font-black text-slate-950">{product}</span>
                      <span className="mt-2 block text-xs font-black text-[#126b9a]">{formatCurrency(productPrice(product, index))}</span>
                    </button>
                  );
                })}
              </div>
            ...
            <section className="rounded-[28px] border border-emerald-950/5 bg-white p-4 shadow-[0_18px_42px_rgba(6,78,59,0.10)]">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-lg font-black text-[#126b9a]">{formatCurrency(total)}</span>
                </div>
              </div>
            </section>
            ...
            <button
              type="button"
              disabled={!canContinue || isCreating}
              className="flex h-14 w-full items-center justify-center gap-2 rounded-[22px] bg-[linear-gradient(135deg,#163d52,#126b9a,#84cc16)] text-sm font-black text-white shadow-[0_18px_34px_rgba(4,120,87,0.22)] transition hover:brightness-105 disabled:bg-none disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none"
              onClick={() => createOrder()}
            >
